/*
	...
	Purpose: Driver Class for using CheckAcct class.
*/
...
public class BankAcctDemo {
    public static void main (String[] args) {
        ...
        // Note: Reminder for Future Self -- annualInterestRate is a  --static-- variable, and get and set methods for it
        // are also --static-- so they use the CLASS name not the instantiated object.s
